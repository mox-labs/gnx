...
name: deep-reasoning
description: >-
  This skill should be used when the user asks to 'write a prompt for o1', 'optimize for reasoning
  models', 'engineer prompts for Deep Think', 'o3 prompting', or needs prompt design for models with
  internal RL (o1, o3, Gemini Deep Think).
---

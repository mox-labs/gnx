...
name: craft-plugins
description: >-
  This skill should be used when the user asks to 'build a plugin', 'create an extension', 'add a
  skill', 'design an agent', 'orchestrate multiple agents', or needs quality methodology for Claude
  Code extension components (skills, commands, agents, hooks, MCP servers).
---

...
name: extracting
description: >-
  This skill should be used when the user asks to 'extract claims from a paper', 'claimify this source',
  'decompose into atomic claims', 'pull findings from this paper', or needs structured claim extraction
  with source quotes and evidence tiers.
metadata:
  version: "0.1.0"
---

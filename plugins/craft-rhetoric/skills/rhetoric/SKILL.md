...
name: rhetoric
description: >-
  This skill should be used when the user asks to 'write docs', 'explain this concept', 'create a
  tutorial', 'make a diagram', 'review content quality', 'design a scrollytelling experience', or
  needs research synthesis, visual explanations, voice evaluation, or collection architecture.
metadata:
  version: "0.3.0"
---

...
name: discourse
description: >-
  This skill should be used when the user asks to 'start a content project', 'figure out what I want
  to say', 'establish ground truth', 'create a voice anchor', or needs to articulate claims before
  writing begins.
metadata:
  version: "0.1.0"
---

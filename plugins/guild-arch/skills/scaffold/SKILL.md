...
name: scaffold
description: >-
  This skill should be used when the user asks to 'scaffold a service', 'set up hexagonal', 'create
  project structure', 'new service', 'init project', or discusses bootstrapping a new codebase.
---

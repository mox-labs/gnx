...
name: craft-tools
description: >-
  This skill should be used when the user asks to 'create a CLI tool', 'design an API', 'improve error
  messages', 'build a developer tool', or needs great developer experience in tool design.
---

...
name: design
description: >-
  This skill should be used when the user asks to "review code design", "check API design", "evaluate
  abstractions", "review naming", "design an API", or discusses code quality, interface design, API
  contracts, or developer experience.
---

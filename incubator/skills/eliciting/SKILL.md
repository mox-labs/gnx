...
name: eliciting
description: >-
  This skill should be used when the user asks to 'scope a research project', 'define research questions',
  'figure out what to research', 'identify sources', or needs to articulate research intent before
  the pipeline begins.
metadata:
  version: "0.1.0"
---

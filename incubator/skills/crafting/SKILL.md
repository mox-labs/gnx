...
name: building
description: >-
  This skill should be used when the user asks to 'write clean code', 'refactor this', 'review this
  code', 'make implementation decisions', or needs engineering craft scaffolds for build quality.
---

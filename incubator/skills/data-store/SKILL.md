...
name: data-store
description: >-
  This skill should be used when the user asks to 'choose a database', 'implement search', 'build
  a RAG system', 'design hybrid retrieval', 'select embedding models', or needs data storage and retrieval
  architecture.
metadata:
  version: "0.1.0"
---

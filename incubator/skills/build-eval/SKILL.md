...
name: build-eval
description: >-
  This skill should be used when the user asks to 'write evals', 'test this agent', 'measure skill
  quality', 'evaluate this prompt', 'build a test suite', or needs eval methodology for agents, multi-agent
  systems, skills, MCP servers, or prompts.
---

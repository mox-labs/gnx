...
name: synthesizing
description: >-
  This skill should be used when the user asks to 'synthesize these findings', 'integrate across sources',
  'map convergence and divergence', 'identify research gaps', or needs cross-source evidence integration
  with gap analysis.
metadata:
  version: "0.1.0"
---

...
name: verifying
description: >-
  This skill should be used when the user asks to 'verify these claims', 'check this against the source',
  'run CoVE', 'fact-check these findings', or needs independent verification of extracted claims against
  source material.
metadata:
  version: "0.1.0"
---

...
name: whitehat
description: >-
  This skill should be used when the user asks for 'security review', 'write a security finding',
  'audit this', 'is this safe to ship', 'teach me about this vulnerability', 'explain this security
  issue', 'help me understand this attack', 'mudge style review', 'bring in mudge', or when producing
  a security finding that needs to actually land — actionable, teaching-oriented, with a falsifying
  test. The review-posture half of security work; composes with trust-boundaries (in guild-arch) for

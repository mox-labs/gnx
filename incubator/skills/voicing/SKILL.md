...
name: voicing
description: >-
  This skill should be used when the user asks to 'review voice quality', 'strip LLM tells', 'check
  if this sounds like me', 'evaluate writing craft', or needs anti-LLM-speak review and voice preservation.
metadata:
  version: "0.3.0"
---

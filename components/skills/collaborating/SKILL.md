...
name: collaboration
description: >-
  This skill should be used when the user asks to 'calibrate trust', 'improve collaboration', 'work
  together effectively', or needs human-AI collaboration patterns, trust calibration, or partnership
  quality improvement.
---

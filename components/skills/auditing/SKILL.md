...
name: auditing
description: >-
  This skill should be used when the user asks to 'audit the research', 'check provenance', 'trace
  claims to sources', 'verify the chain', or needs end-to-end quality assurance on research outputs.
metadata:
  version: "0.1.0"
---

...
name: figures
description: >-
  This skill should be used when the user asks to 'make a diagram', 'create a visualization', 'design
  an animation', 'choose the right diagram type', or needs visual explanations using Mermaid, D2,
  C4, dataviz, or cinematic animation.
metadata:
  version: "0.1.0"
---

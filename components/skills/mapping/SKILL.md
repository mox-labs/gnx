...
name: mapping
description: >-
  This skill should be used when the user asks to 'survey these sources', 'map what we have', 'create
  a map of contents', 'inventory these papers', or needs to understand what sources exist before going
  deep.
metadata:
  version: "0.1.0"
---

...
name: arranging
description: >-
  This skill should be used when the user asks to 'organize these docs', 'structure this documentation
  site', 'design reading paths', 'audit content hierarchy', or needs collection architecture and single
  source of truth.
metadata:
  version: "0.1.0"
---

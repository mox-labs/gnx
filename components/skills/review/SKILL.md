...
name: review
description: >-
  This skill should be used when the user asks to "run an antifragile review", "ACES review", "do
  an antifragile review on this", "review this for structural fragility", "diagnose this platform",
  "check this platform for the cycle", or requests a focused structural review using the ACES (Adaptable,
  Composable, Extensible Software) framework. Composes with other review skills; does not replace
  them.
---

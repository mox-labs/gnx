...
name: evaluating
description: >-
  This skill should be used when the user asks to 'is this ready to ship', 'does this content work',
  'evaluate this piece', 'check evidence quality', or needs propagation testing and evidence verification.
metadata:
  version: "0.1.0"
---

...
name: research
description: >-
  This skill should be used when the user asks to 'research this topic', 'analyze these papers', 'do
  a literature review', 'synthesize research', 'extract claims', 'verify citations', 'scope a research
  project', or needs systematic research with evidentiary provenance.
metadata:
  version: "0.3.0"
---

...
name: discovering
description: >-
  This skill should be used when the user asks to 'comprehend this source material', 'understand this
  research before writing', 'analyze this before documenting', or needs deep comprehension of source
  material before creating content.
metadata:
  version: "0.2.0"
---

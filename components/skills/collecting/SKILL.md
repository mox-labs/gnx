...
name: collecting
description: >-
  This skill should be used when the user asks to 'collect sources for research', 'find papers on
  a topic', 'set up source collection', 'build a recon config from my research scope', or needs to
  bridge a research scope into mechanical source collection via recon.
metadata:
  version: "0.1.0"
---
